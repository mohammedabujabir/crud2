 ...
 <div className="container-fluid">
  <div className="row flex-nowrap">
   ...
   <form onSubmit={sendData}>
    ...
    <Input errors={errors} id={'email'} title={'user email'} type={'text'} name={'email'}  handelData={handelData}/>
    
    <Input errors={errors} id={'password'} title={'user password'} customClasses='bg-white'type={'password'} name={'password'}  handelData={handelData}/>
